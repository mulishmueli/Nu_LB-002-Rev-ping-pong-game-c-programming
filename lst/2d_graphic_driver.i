...

{
	...
	if (color==0) {
		...
		case 0: DisplayBuf[x+y/8*128] &= 0xFE;  break;

		case 1: DisplayBuf[x+y/8*128] &= 0xFD;  break;

		case 2: DisplayBuf[x+y/8*128] &= 0xFB;  break;

		case 3: DisplayBuf[x+y/8*128] &= 0xF7;  break;

		case 4: DisplayBuf[x+y/8*128] &= 0xEF;  break;

		case 5: DisplayBuf[x+y/8*128] &= 0xDF;  break;

		case 6: DisplayBuf[x+y/8*128] &= 0xBF;  break;

		case 7: DisplayBuf[x+y/8*128] &= 0x7F;  break;
		...
		case 0: DisplayBuf[x+y/8*128] |= 0x01;  break;

		case 1: DisplayBuf[x+y/8*128] |= 0x02;  break;

		case 2: DisplayBuf[x+y/8*128] |= 0x04;  break;

		case 3: DisplayBuf[x+y/8*128] |= 0x08;  break;

		case 4: DisplayBuf[x+y/8*128] |= 0x10;  break;

		case 5: DisplayBuf[x+y/8*128] |= 0x20;  break;

		case 6: DisplayBuf[x+y/8*128] |= 0x40;  break;

		case 7: DisplayBuf[x+y/8*128] |= 0x80;  break;
