...
#line 11 "Smpl_LCD_PingPong.c"


#line 14 "Smpl_LCD_PingPong.c"
#line 15 "Smpl_LCD_PingPong.c"
...
int32_t main (void)
{
	...
	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x00;;
	...
	LineBresenham(120,yr-7, 120,yr+7,1);
	LineBresenham(7,yl-7, 7,yl+7,1);
	...
	while(1) 
		...
		if (number!=0)		
		{
			if (number==3)
			{
				LineBresenham(120,yr-7,120,yr+7,0);
				yr--;
				LineBresenham(120,yr-7, 120,yr+7,1);
			}
